...
write.table(nameResASig, file='TreatmentAvsControl_DE_pAdj0.05.txt',sep='\t',quote=FALSE)
write.table(nameResBSig, file='TreatmentBvsControl_DE_pAdj0.05.txt',sep='\t',quote=FALSE)
